...
urlpatterns = [
    ...
    path('prenotazioni/<uuid:pk>/azione/', views.BookingActionView.as_view(), name='booking_action'),
    ...
    path('blocchi/<uuid:pk>/elimina/', views.DeleteBlockView.as_view(), name='delete_block'),
